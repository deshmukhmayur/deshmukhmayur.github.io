...
- Layout: neofetch-style about header (figlet "MAYUR" + whoami → name, résumé.pdf link, one-line bio, `now → employer · tenure`) sitting directly on the background; then panes: work (wide, with skills pane beside it), art + prints row, studies + soliloquy row.
